...
const Footer = () => {
  return (
    <div className="mt-8 bg-[#213b52] pt-9">
    <div className="mx-auto w-full max-w-[1166px] px-4 xl:px-0">
      <div className="flex flex-col justify-between sm:px-[18px] md:flex-row md:px-10">
        <div className="md:w-[316px]">
          <div className="text-[18px] font-medium text-white">
          
          <Image src={LogoImg} alt="Logo" width={200} height={100} className="rounded-lg" />
          </div>
        ...
        <div className="md:w-[316px]">
          <div className="mt-[23px] flex">
            ...
            <div className="ml-[18px]">
              <Link href="tel:+911800123444" className="font-Inter text-[14px] font-medium text-white">+91-7709 502204</Link>
          ...
          <div className="mt-[23px] flex">
            ...
            <div className="ml-[18px]">
              <Link href="mailto:help@lorem.com" className="font-Inter text-[14px] font-medium text-[#fff]">info@quantisysglobal.com</Link>
          ...
          <div className="mt-[23px] flex">
            ...
            <div className="ml-[18px]">
              <Link href="mailto:help@lorem.com" className="font-Inter text-[14px] font-medium text-[#fff]">The VUE # 9, Parge Colony, Pune, Maharashtra 411048, IN </Link>
        ...
        <div className="mt-6 flex w-full flex-col justify-between text-white sm:flex-row md:mt-0 md:max-w-[341px]">
          <div className="">
            ...
            <ul>
              ...
              <li className="mt-[15px]"><Link
                  className="text-deutziawhite hover:text-deutziawhite/80 font-inter text-[15px] font-normal hover:font-semibold"
                  href="/our-tutors">About</Link></li>
              <li className="mt-[15px]"><Link
                  className="text-deutziawhite hover:text-deutziawhite/80 font-inter text-[15px] font-normal hover:font-semibold"
                  href="/become-Link-tutor">Service</Link></li>
              <li className="mt-[15px]"><Link
                  className="text-deutziawhite hover:text-deutziawhite/80 font-inter text-[15px] font-normal hover:font-semibold"
                  href="/plans-and-pricing">Contact</Link></li>
              <li className="mt-[15px]"><Link
                  className="text-deutziawhite hover:text-deutziawhite/80 font-inter text-[15px] font-normal hover:font-semibold"
                  href="/terms-and-conditions">Terms and conditions</Link></li>
              <li className="mt-[15px]"><Link
                  className="text-deutziawhite hover:text-deutziawhite/80 font-inter text-[15px] font-normal hover:font-semibold"
      ...
      <div className="flex items-center justify-center pb-8 pt-[9px] md:py-8">
        <p className="text-[10px] font-normal text-white md:text-[12px]">
          © Copyright
           ...
           All Rights Reserved by Quantisys.com
        </p>
      </div>
    </div>
  </div>
