  ...
  return (
    <>
      ...
      <div className="bg-white overflow-hidden" id="services">
        ...
        <div className="container mx-auto px-10" data-aos="fade-up" id="travel">
          <div className="row flex justify-center">
            <div className="col-lg-10 px-4">
              <div
                className="text-center mt-6 h-12 sm:h-3 md:h-7 lg:h-10 xl:h-15 "
                data-aos="fade-up"
              >
                <h2 className="text-3xl text-[#213b52] font-bold mb-10">
                  {" "}
                  Travel Agency
                </h2>
              </div>
        ...
        <div className="container mx-auto" data-aos="fade-up">
          <div className="flex justify-center">
            <div className="col-lg-4 px-4">
              <div
                className="geral-responsiveImage p-0 aos-init aos-animate"
                data-editor="responsiveImage"
                data-aos="slide-up"
              >
              ...
              <div className="text-center mt-6">
                ...
                <p className="text-2xl text-[#213b52] font-semibold">
                  Make client setup, bookings, and trip management simple and
                  intuitive
                </p>
              </div>
              <div className="text-center mt-4">
                <p className="text-lg px-10">
                  Deliver world-class sales and bookings support for groups of
                  any size. Keep clients coming back with easy-to-use client
                  tools, integrated support channels, and premium concierge
                  services.
                </p>
              </div>
            </div>
            ...
            <div className="col-lg-4 px-4">
              ...
              <div className="text-center mt-6">
                ...
                <p className="text-2xl text-[#213b52]  font-semibold">
                  Integrate back-office functions to streamline fulfillment,
                  ticketing, and more
                </p>
              </div>
              <div className="text-center mt-4">
                <p className="text-lg px-10">
                  Integrate critical front-and-back-office functions to ensure
                  consistent, high-quality customer engagement across all
                  touchpoints and throughout the trip management process.
                </p>
              </div>
            </div>
          </div>
      ...
      <div className=" py-12" data-aos="fade-up">
        ...
        <div className="container mx-auto px-10" data-aos="fade-up">
          <div className="row flex justify-center">
            <div className="col-lg-10 px-4">
              <div
                className="text-center mt-10 h-12 sm:h-3 md:h-7 lg:h-10 xl:h-15 "
                data-aos="fade-up"
              >
                <h2 className="text-3xl text-[#213b52] font-bold mb-10">
                  Airlines
              ...
              <div className="text-center mt-6">
                <p className="text-lg px-4 start">
                  Despite the many headwinds airlines have had to navigate in
                  recent years, growth and prosperity are on the horizon. With
                  the right business services partner, they can achieve higher
                  employee satisfaction (E-SAT) and customer satisfaction
        ...
        <div className="container mx-auto" data-aos="fade-up">
          <div className="flex justify-center">
            ...
            <div className="col-lg-4 px-4">
              ...
              <div className="text-center mt-4">
                <p className="text-lg px-10">
                  Eliminate counterproductive silos by digitally integrating the
                  front, middle, and back-office functions. Streamline
                  end-to-end business operations and connect the entire customer
                  journey to ensure consistent experiences across all
                  touchpoints.
                </p>
              </div>
            </div>
        ...
        <div className="container mx-auto px-10" data-aos="fade-up">
          <div className="row flex justify-center">
            <div className="col-lg-10 px-4">
              ...
              <div className="text-center mt-6">
                <p className="text-lg px-4">
                  Optimize the guest experience with integrated reservation
                  management and on-site support via the channels they prefer.{" "}
                </p>
              </div>
        ...
        <div className="container mx-auto" data-aos="fade-up">
          <div className="flex justify-center">
            <div className="col-lg-4 px-4">
              ...
              <div className="text-center mt-4">
                <p className="text-lg px-10">
                  Streamline reservation management with intuitive self-service
                  tools and integrated support options that increase
            ...
            <div className="col-lg-4 px-4">
              ...
              <div className="text-center mt-4">
                <p className="text-lg px-10">
                  Use integrated, digital-first tools to keep guests close and
                  connected during their stay. Then, help them plan return
                  visits with upsell and cross-sell offers and options.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="col-lg-10 px-4">
              ...
              <div className="text-center mt-6">
                <p className="text-lg px-4">
                  ...
                  digital-first approach that will create companywide
                  efficiencies.{" "}
                </p>
              </div>
          ...
          <div className="flex justify-center">
            <div className="col-lg-4 px-4">
              ...
              <div className="text-center mt-6">
                ...
                <p className="text-2xl text-[#213b52] font-semibold">
                  {" "}
                  Empower travelers through intuitive, self-service tools and
                  integrated customer support options
                </p>
              </div>
              <div className="text-center mt-4">
                <p className="text-lg px-10">
                  Deliver a frictionless travel experience with easy-to-use
                  booking and support tools, and increase upsell conversions
                  with intelligent offers via each customer&props;s preferred
                  channels.
                </p>
              </div>
            </div>
            ...
            <div className="col-lg-4 px-4">
              ...
              <div className="text-center mt-6">
                ...
                <p className="text-2xl text-[#213b52]  font-semibold">
                  Eliminate back-office silos to maximize business-wide
                  efficiencies
                </p>
              </div>
              <div className="text-center mt-4">
                <p className="text-lg px-10">
                  By integrating critical front-and-back office functions and
                  applying proven Lean Six Sigma methodologies, companies can
                  drive end-to-end efficiencies through process automation and
        ...
        <div className=" py-12" data-aos="fade-up">
          <div className="relative">
            ...
            {/* Content Over Image */}
            <div className="relative z-10 flex items-center justify-center h-[300px]">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-white text-center"></div>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-10" data-aos="fade-up">
          <div className="row flex justify-center">
            <div className="col-lg-10 px-4">
              ...
              <div className="text-center mt-6">
                <p className="text-lg px-4">
                  Accelerate recovery by maximizing bookings and upsell
                  conversions, while also maximizing operational efficiencies
                  with an intelligent, digital-first approach including process
                  automation.{" "}
                </p>
              </div>
              <div className="text-center mt-6 ">
        ...
        <div className="container mx-auto" data-aos="fade-up">
          <div className="flex justify-center">
            <div className="col-lg-4 px-4">
              ...
              <div className="text-center mt-4">
                <p className="text-lg px-10">
                  Simplify the reservation management process with <br />{" "}
                  simple, self-service options, offer easy-to-add upgrades and
                  excursions,
                  <br />
                  and maintain close contact with travelers while on-board.
                </p>
              </div>
            </div>
            <div className="col-lg-4 px-4">
              ...
              <div className="text-center mt-4">
                <p className="text-lg px-10">
                  Increase up-sell conversions with predictive modeling and
                  integrated, cross-channel promotions.
                </p>
              </div>
            </div>
          </div>
