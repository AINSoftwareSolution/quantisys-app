...
export const WhyChooseUs = [
    {
      id:1,
      title: " Streamlining operations to improve efficiency and reduce costs.",
      description: "Quantisys boosts operational efficiency and minimizes costs by streamlining processes and improving back-office functions, with flexibility to handle seasonal business changes.",
      imgSrc: OperationImg,
      icon: "bi-activity",
    ...
    {
      id:2,  
      title: "Regulatory Compliance and Adherence to Standards",
      description: "Our compliance management solutions guarantee consistent alignment with the latest travel industry regulations and standards, emphasizing our dedication to maintaining exceptional quality and reliability.",
    ...
    },
    {
      ...
      description: "Quantisys provides round-the-clock multilingual support, ensuring swift and efficient resolution of customer inquiries via our dedicated call centers, live chat, and email assistance.",
      imgSrc: CustomerImg,
      icon: "bi-easel",
      link: "service-details.html",
    },
    {
      id:4,
      title: "Advanced Technology and Robust Infrastructure",
      description: " Quantisys delivers cutting-edge technology solutions, encompassing cloud computing, IT infrastructure optimization, and comprehensive tech support, to provide a secure, scalable, and high-performance digital ecosystem.",
      imgSrc: TechImg,
    ...
    {
      id:5,
      title: "Adaptability and Growth Potential",
      description: "Our solutions are tailored to grow alongside your business, providing adaptability and agility to address evolving market needs and support sustained business expansion.",
